...
public class Vehicle implements Serializable {
    ...
    public String toString() {
        return "Vehicle{" + "id=" + id + ", make='" + make + '\'' + ", model='" + model + '\'' + ", characteristics='" + characteristics + '\'' + ", yearOfProduction=" + yearOfProduction + ", odometer=" + odometer + ", color='" + color + '\'' + ", licensePlate='" + licensePlate + '\'' + ", numberOfSeats=" + numberOfSeats + ", price=" + price + ", requiredLicense=" + requiredLicense  + ", bodyType=" + bodyType + '}';
    }
}
